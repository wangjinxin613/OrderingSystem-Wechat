...
<html>
	...
	<body>
		<div class="head">
			<a href="card.php"><img src="../images/return.png" style="width:23px;float:left;margin-left:20px;"></a><span style=";">我的代金券</span><span style="width:40px;float:right;">&nbsp;</span>
		</div>
