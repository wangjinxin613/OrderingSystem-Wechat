...
<html>
	...
	<body>
		<div class="head">
			<img src="../images/return.png" style="width:23px;float:left;margin-left:20px;" onClick="javascript:history.back(-1)"><span style=";">优惠券兑换</span><span style="width:40px;float:right;">&nbsp;</span>
		</div>
