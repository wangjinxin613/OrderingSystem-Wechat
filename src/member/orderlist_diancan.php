...
<html>
	...
	<body>
		<div class="head">
			<img src="../images/return.png" style="width:23px;float:left;margin-left:20px;" onClick="javascript:history.back(-1)"><span style=";">店内点餐-买单记录</span><span style="width:40px;float:right;">&nbsp;</span>
		</div>
		...
		if($type==null|| $type==1){
			...
			orderlist_foreach('1','and status = 0');
		}else if($type==3){
			orderlist_foreach('1','and status = 1 and status_ss = 0');
		}else if($type==4){
			orderlist_foreach('1','and status = 1 and status_ss = 1');
		}
		?>
