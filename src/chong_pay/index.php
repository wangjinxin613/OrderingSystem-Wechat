...
<html >
	...
	<body >
     ...
     <div class="box">
	       <input type="text" style="width:100%;border:0;outline:none;" id="money" placeholder="请输入服务员确认的金额"<? if($money !=null){ echo "value='$money'";}?> >
      </div>
      <input type="text" name="money" id="z_money" style="width:100%;border:0;outline:none;display:none;">
      <div class="juli"></div>
	    <div class="pricebox">
