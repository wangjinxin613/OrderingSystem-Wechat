...
<body>
<div class="page-content clearfix" style="width:80%;">
 <div class="sort_style">
     <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:ovid()" id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加新的台号</a>
    ...
    <table class="table table-striped table-bordered table-hover" id="sample-table">
		<thead>
		 <tr>
				...
				<th width="150px">台号名称</th>
			
				<th width="80px">所属门店</th>
				<th width="50px">操作</th>
			</tr>
		</thead>
	<tbody>
...
<div class="sort_style_add margin" id="sort_style_add" style="display:none">
  <div class="">
     <ul>
     	<form action="action/taihao_add.php" method="POST">
      <li><label class="label_name">台号名称</label><div class="col-sm-9"><input name="tai_name" type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5"></div></li>
       <li><label class="label_name">排列顺序</label><div class="col-sm-9"><input name="shunxu" type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5"></div></li>
        <li><label class="label_name">所属分店</label><div class="col-sm-9">
        	<select name="fen_id" style="margin-left:10px;width:210px;">
