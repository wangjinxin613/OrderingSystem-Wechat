...
<body>
   ...
   <div class="type_title">添加门店</div>
	<form action="zo/shop_add_action.php" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="clearfix cl">
         <p>门店名称：<input type="text"  value="" placeholder="请输入门店名称" id="" name="store_name" class="inp" required>	</p>
		</div>
		<div class="clearfix cl">
         <p>系统版本：
         	<select style="width:300px;margin-left:5px;" name="sort_id">
         			<?select_banben();?>
         	</select> 
         	</p>
		</div>
		<div class="clearfix cl">
       <p>门店地址：<input type="text"  value="" placeholder="请输入门店地址" id="" name="store_place" class="inp" required>	</p>
         	</p>
		</div>
		<div class="clearfix cl">
         <p>电话号码：<input type="text"  value="" placeholder="请输入电话号码" id="" name="store_phone" class="inp" required></p>
		</div>
		<div class="clearfix cl">
         <p style="margin-left:-14px;">创始人账号：<input type="text"  value="" placeholder="请输入创始人账号，用于登录商户后台" id="" name="admin_name" class="inp" required></p>
		</div>
		<div class="clearfix cl">
         <p>登录密码：<input type="password"  value="" placeholder="请输入登录密码" id="" name="admin_password" class="inp" required></p>
		</div>
		<div class="clearfix cl">
         <p>门店头像：</p>
        <P><img src=""></P>
