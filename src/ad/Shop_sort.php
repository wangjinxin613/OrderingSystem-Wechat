<?php
 	require('config/index_class1.php');//引入公共类文件
...
<body>
 ...
 <div class="sort_style">
     <div class="border clearfix">
       <span class="l_f">
        <a href="shop_sort_add.php" id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加版本</a>
    ...
    <table class="table table-striped table-bordered table-hover" id="sample-table">
		<thead>
		 <tr>
				...
				<th width="160px">使用时限（单位：天）</th>
				<th width="160px">授权价格（单位：元）</th>
