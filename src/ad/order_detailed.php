<?
  ...
  $sql = "update orderlist set du = '1' where id = '$id'";
  mysql_query($sql);
?>
...
<div class="Numbering">订单编号:<b><? order_detail($id,'2');?></b></div></div>
 ...
 <!--收件人信息-->
    ...
    <div class="Total_style">
     <div class="Info_style clearfix">
      ...
      <div class="Total_m_style"><span class="Total"></span><span class="Total_price">总价：<b>  <? order_detail($id,'4');?></b>元</span></div>
    </div>
