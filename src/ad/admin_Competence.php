...
<body>
 <div class="margin clearfix">
   <div class="border clearfix">
       <span class="l_f">
        <a href="Competence.php" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i> 添加权限</a>
			...
			<tr>
             ...
             <tbody>
			  <tr>
				...
				<td>拥有至高无上的权利,拥有最高权限</td>
				<td>
                 <a title="编辑" onclick="alert('此处不可编辑')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
                 <a title="删除" href="javascript:;"  onclick="alert('不可删除')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
				</td>
			   </tr>
             <?admin_dept_list();?>
		      </tbody>
