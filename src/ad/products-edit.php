...
<body>
	...
	$result = mysql_query("SELECT * FROM product JOIN product_sort ON product.sort_id = product_sort.id where pid = '$id' ");
   ...
   <div class="page_right_style" style="margin-left:100px;">
	...
	<form action="action/products_edit_action.php?id='; echo $row['pid'];echo '" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
    ...
    <div class="clearfix cl">
         <p style="margin-left:-25px;">购买获得积分：<input type="text"  value="';echo $row['get_points']; echo '" placeholder="请输入购买获得积分" id="" name="get_points" class="inp" required></p>
		</div>
		<div class="clearfix cl">
         <p>商品图片：</p>
