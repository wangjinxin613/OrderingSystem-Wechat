...
<div class="margin clearfix">
    ...
    <div class="border clearfix">
       <span class="l_f">
        ...
        <a href="?type=1" class="btn btn-sm btn-primary"><i class="fa fa-check"></i>&nbsp;已审核</a>
        <a href="?type=0" class="btn btn-yellow"><i class="fa fa-times"></i>&nbsp;未审核</a>
       </span>
