<?
	include_once('../config/index_class.php');
...
<html >
	...
	<body >
		...
		<form action="action/shou_action.php" method="POST" id="tijiao">
		<div class="head">
			<a href="index.php"><img src="../../images/return.png" style="width:23px;float:left;margin-left:20px;" ></a><span style=";">员工收银</span><span style="width:40px;float:right;">&nbsp;</span>
		</div>
	   <div style="height: 49px;"></div>
     <div class="money" ng-app="">
     <p style="padding:5px 10px;">本次消费金额</p>
     <div class="box">
	       <input type="text" name="money" value="" style="width:100%;border:0;outline:none;" id="money" placeholder="请输入要收款的金额" step="0.01"  ng-model="quotnObject.quotnInfo.InterestTotal" currency-format="number" >
      </div>
