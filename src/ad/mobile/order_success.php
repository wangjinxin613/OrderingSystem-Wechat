...
<html>
	...
	<body>
		<div class="head">
			<a href="cg_shoplist.php"><img src="../../images/return.png" style="width:23px;float:left;margin-left:20px;" ></a><span style=";">操作成功</span><span style="width:40px;float:right;">&nbsp;</span>
		</div>
		<div style="padding-bottom:48px;"></div>
		<img src="../../images/duihao.png" style="width:30%;margin:20px 35%;">
		<div class="font">
			<p>操作成功，订单已提交，请耐心等待为您配送</p>
