...
<html>
	...
	<body>
		<div class="head">
			<a href="index.php"><img src="../../images/return.png" style="width:23px;float:left;margin-left:20px;" ></a><span style=";">订单查询-最近订单</span><span style="width:40px;float:right;">&nbsp;</span>
		</div>
		<div style="padding-bottom:50px;"></div>
		<div class="title">
			<ul>
				<a href="order_shishi.php"><li>最近订单</li></a>
      ...
      <p style="margin-top:10px 10px;font-size:10px;color:#FF0033;float:right;padding-right:10px;">* 最近订单只能查询24小时之内的订单</p>
