...
<div class="page-content clearfix">
    <div id="Member_Ratings">
       ...
       <span class="l_f">
        <a href="?type=1"  class="btn btn-warning">今日新增</a>
      	...
      	<a href="?type=4" class="btn btn-warning">本年新增</a>
      	 	<a href="phpexcel/user_list.php?type=<? echo $type;?>"  class="btn">导出以下数据</a>
       </span>
     ...
     <div class="table_menu_list">
       <table class="table table-striped table-bordered table-hover" id="sample-table" style="font-size:10px">
		<thead>
		 <tr>
