...
<div class="page-content clearfix">
 <div class="sort_style">
     <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:ovid()" id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i>发送通知</a>
    ...
    <table class="table table-striped table-bordered table-hover" id="sample-table">
		<thead>
		 <tr>
				...
				<th width="150px">通知会员</th>
				<th width="200px">通知标题</th>
        <th width="350px">通知内容</th>
...
<div class="sort_style_add margin" id="sort_style_add" style="display:none">
  <div class="">
     <ul>
     	<form action="action/notice_add_dept.php" method="POST">
        <li><label class="label_name">通知人群</label><div class="col-sm-9">
          <select style="width:300px;margin-left:10px;" name="rank">
            <option value="all">全部会员</option>
            <? member_rank_list($admin_sql1,'1');?>
          </select>
        </div></li>
      <li><label class="label_name">通知标题</label><div class="col-sm-9"><input name="no_title" type="text" id="form-field-1" placeholder="" style="width:400px;"></div></li>

      <li><label class="label_name">通知内容</label><div class="col-sm-9"><textarea name="no_body" class="form-control" id="form-field-8" placeholder="" onkeyup="checkLength(this);"></textarea><span class="wordage">剩余字数：<span id="sy" style="color:Red;">200</span>字</span></div></li>
