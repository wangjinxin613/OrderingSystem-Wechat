...
<body>
	<div class="add_menber" id="add_menber_style" style="">
		<form action="action/youhui_update.php" method="post">
   <?php
	...
	$result = mysql_query("SELECT * FROM youhui_list where id = '$id' ");
	while($v = mysql_fetch_array($result))
 	{
 		echo '
    <ul class=" page-content">
     <li><label class="label_name">类型：</label><span class="add_name">
		 <input type="radio" value="1" class="text_add" name="y_type" '; if($v['type']==1){ echo 'checked="true"';}echo '/>无门槛减<input type="text" value="';echo $v['wu_money']; echo '" style="width:40px;margin:0;" name="wu_money"/>元
		 <input type="text" value="';echo $v['id']; echo '" name="id" style="display:none;"/>
		 <li> <input type="radio" value="2" class="text_add" name="y_type"'; if($v['type']==2){ echo 'checked="true"';}echo '/>满<input type="text" value="';echo $v['man_max']; echo '" style="width:40px;margin:0;" name="man_max"/>减<input type="text" value="';echo $v['man_min']; echo '" style="width:40px;margin:0;" name="man_min"/>元
