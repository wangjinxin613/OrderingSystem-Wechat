...
<body>
	<div class="add_menber" id="add_menber_style" style="">
		<form action="action/lipin_update.php" method="post">
   <?php
	...
	$result = mysql_query("SELECT * FROM lipin_list where id = '$id' ");
	while($v = mysql_fetch_array($result))
 	{
 		echo '
    <ul class=" page-content">
     <li><label class="label_name">礼品：</label><span class="add_name">
		 <input type="text" value="';echo $v['id']; echo '" name="id" style="display:none;"/>
		 <input name="l_name" type="text" value="';echo $v['name']; echo '" class="text_add"/></span><div class="prompt r_f"></div></li>
