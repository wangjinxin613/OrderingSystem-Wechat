...
<div class="page-content clearfix">
 <div class="sort_style">
     <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:ovid()" id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加优惠券</a>
...
<div class="sort_style_add margin" id="sort_style_add" style="display:none">
  <div class="">
     <ul>
     	<form action="action/youhui_add.php" method="POST">
      <li><label class="label_name">类型</label><div class="col-sm-9"><input name="y_type" type="radio" id="form-field-1" value="1" style="margin-left:10px;">无门槛减<input type="text" value="" name="wu_money" style="width:40px;margin:0">元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="y_type" type="radio" value="2" id="form-field-1" placeholder="" style="margin-left:10px;">满<input type="text" value="" name="man_max" style="width:40px;margin:0">减<input type="text" value="" name="man_min" style="width:40px;margin:0">元</div></li>
