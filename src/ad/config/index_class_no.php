 ...
 */
 ...
 function order_right_body(){
    ...
    echo '<li class="lt-rt" style="width:40%;float:left;">
			    	<img src="../';echo $r['products_img']; echo '" class="list-pic" style="height:120px;"/></a>
      ...
      foreach($rows as $key=>$v){
      	echo '
            <tr>
             ...
             <td class="td-manage">
              <form action="" method="post" style="float:left;margin-left:80px;"><p><a title="编辑" onclick='; echo "'"; echo 'member_edit("编辑台号","taihao_edit.php?id=';echo $v['id']; echo '","4","","200")';echo "'"; echo ' href="javascript:;"  class="btn btn-xs btn-info" ><i >编辑</i></a></form>
