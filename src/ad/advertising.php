	...
	<div class="page-content clearfix">
	 <div class="sort_adsadd_style">
	  <div class="border clearfix">
	       <span class="l_f">
	        <a href="javascript:ovid()"  id="ads_add" title="添加品牌" class="btn btn-warning Order_form"><i class="fa fa-plus"></i> 添加幻灯片</a>
...
?>
	...
	<div id="add_ads_style"  style="display:none">
	 ...
	 <ul>
	  ...
	  <form action="action/adver_add_action.php" method="POST" enctype="multipart/form-data">
	  <li><label class="label_name">显示排序</label><span class="cont_style"><input name="sx" type="text" id="form-field-1" placeholder="0" class="col-xs-10 col-sm-5" style="width:50px"></span></li>


	     <li><label class="label_name">图片</label><span class="cont_style">
	     <BR> <BR> <BR><input type="file" name="image"/> 此图片长宽比例最好接近4:2
