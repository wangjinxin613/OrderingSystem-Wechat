...
class UnifiedOrder_pub extends Wxpay_client_pub
{
	...
	{
		//设置接口链接
		$this->url = "http://api.cmbxm.mbcloud.com/alipay/orders/precreate";
		//设置curl超时时间
...
class OrderQuery_pub extends Wxpay_client_pub
{
	...
	{
		//设置接口链接
		$this->url = "http://api.cmbxm.mbcloud.com/wechat/orders/query";
		//设置curl超时时间
		$this->curl_timeout = WxPayConf_pub::CURL_TIMEOUT;
	}
...
class Refund_pub extends Wxpay_client_pub
{
	...
	function __construct() {
		//设置接口链接
		$this->url = "http://api.cmbxm.mbcloud.com/wechat/refunds";
		//设置curl超时时间
		$this->curl_timeout = WxPayConf_pub::CURL_TIMEOUT;
	}
