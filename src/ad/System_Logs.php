 ...
 <div id="system_style">
     <div class="search_style" style="display:none">
      ...
      <ul class="search_content clearfix">
       <li><label class="l_f"></label><input name="" type="text" class="text_add"style=" width:250px"></li>
       <li><label class="l_f"></label><input class="inline laydate-icon" id="start" style=" margin-left:10px;" ></li>
