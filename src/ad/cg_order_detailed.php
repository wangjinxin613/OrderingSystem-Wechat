...
<div class="Numbering">订单编号:<b><? cg_order_detail($id,'2');?></b></div></div>
 <div class="detailed_style">
 <!--收件人信息-->
    <? cg_order_detail($id,'1');?>
    <!--订单信息-->
    <div class="product_style">
    <div class="title_name">产品信息</div>
    <div class="Info_style clearfix">
      <? cg_order_product($id,'2')?>
    ...
    <div class="Total_style">
     <div class="Info_style clearfix">
      ...
      <div class="Total_m_style"><span class="Total"></span><span class="Total_price">总价：<b>  <? cg_order_detail($id,'4');?></b>元</span></div>
    </div>
...
<div class="Button_operation">
				<button onclick="history.back();" class="btn btn-primary radius" type="submit"><i class="icon-save "></i>返回上一步</button>
