...
<div class="page-content clearfix">
 ...
 <div class="sort_style">
     <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:ovid()" id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加分类</a>
       	...
       	<a style="color:red;font-size:18PX;margin-left:50px;">*删除分类对应的该分类下的商品也会被删除，请谨慎操作</a>
       </span>
  ...
  <div class="sort_list">
	...
	<tbody>
			 <?php
product_sort_list($admin_sql1,$fen_id);
      ?>
    </tbody>
    </table>
  </div>
...
<div class="sort_style_add margin" id="sort_style_add" style="display:none">
  <div class="">
     <ul>
     	<form action="action/product_sort_adtion.php" method="POST">
      <li><label class="label_name">门店</label><div class="col-sm-9">
          <select style="width:200px;margin-left:10px;" name="fen_id">
            <option value="0">总店</option>
            <?fendian_list('2');?>
          </select>
      </div></li>
      <li><label class="label_name">分类名称</label><div class="col-sm-9"><input name="sort_name" type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5"></div></li>
       <li><label class="label_name">排列顺序</label><div class="col-sm-9"><input name="sort_sx" type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5"></div></li>
      <li><label class="label_name">分类说明</label><div class="col-sm-9"><textarea name="sort_body" class="form-control" id="form-field-8" placeholder="" onkeyup="checkLength(this);"></textarea><span class="wordage">剩余字数：<span id="sy" style="color:Red;">200</span>字</span></div></li>
