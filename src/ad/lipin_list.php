...
<div class="page-content clearfix">
 <div class="sort_style">
     <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:ovid()" id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加礼品券</a>
      	**礼品券各分店通用
       </span>
...
<div class="sort_style_add margin" id="sort_style_add" style="display:none">
  <div class="">
     <ul>
     	<form action="action/lipin_add.php" method="POST">
      <li><label class="label_name">礼品名称</label><div class="col-sm-9"><input name="l_name" type="text" id="form-field-1" placeholder="" style="width:400px;"></div></li>
       <li><label class="label_name">数量</label><div class="col-sm-9"><input name="number1" type="text" id="form-field-1" placeholder="" style="width:70px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;兑换所需积分<input name="points" type="text" id="form-field-1" placeholder="" style="width:70px;"></div></li>
...
jQuery(function($) {
		...
		"aoColumnDefs": [
		  ...
		  {"orderable":false,"aTargets":[0,3,7,8]}// 制定列不参与排序
		] } );
