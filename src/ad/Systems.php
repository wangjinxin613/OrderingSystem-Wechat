...
<div class="margin clearfix">
 <div class="stystems_style">
  <div class="tabbable">
	...
	while($row = mysql_fetch_array($result))
 	{
 		echo '<form action="action/system_edit_action.php" method="post" enctype="multipart/form-data">
    <div class="tab-content">
		...
		<p style="padding-bottom:15px;">[备注]：填写地址坐标请访问 <a href="http://lbs.qq.com/tool/getpoint/">http://lbs.qq.com/tool/getpoint/</a> 获取</p>
         <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>门店名称： </label>
          <div class="col-sm-9"><input type="text" name="store_name" id="website-title" value="';echo $row['store_name']; echo '" class="col-xs-10 "></div>
          </div>
          <!--
          ...
          <div class="col-sm-9"><input type="text" id="website-title" name="zuobiao" value="'; echo $row['zuobiao']; echo '" class="col-xs-10 "><a href="http://lbs.qq.com/tool/getpoint/">获取地址坐标</a></div>
					...
					<div class="col-sm-9"><input type="text" id="website-title" name="store_place" value="'; echo $row['store_place']; echo '" class="col-xs-10 "></div>
					</div>
	      <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>联系电话： </label>
          <div class="col-sm-9"><input type="text" id="website-title" name="store_phone" value="';echo $row['store_phone']; echo '" class="col-xs-10"></div>
          </div>
          <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>门店价格： </label>
          <div class="col-sm-9"><input type="text" id="website-title" name="store_price" value="'; echo $row['store_price']; echo '" class="col-xs-10"></div>
          </div>
          ...
          <div class="col-sm-9" style="margin-left:10px;"><input name="store_wifi" type="radio" value="0" '; if($row['store_wifi']==0){echo ' checked="checked"';} echo 'class="ace col-xs-10"><span class="lbl">不支持</span>
          	<input  name="store_wifi" type="radio" value="1" class="ace" '; if($row['store_wifi']==1){echo ' checked="checked"';} echo '><span class="lbl">支持</span></div>
          </div>
           <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>停车位数量： </label>
          <div class="col-sm-9"><input type="text" id="website-title" name="store_paking" value="';echo $row['store_paking']; echo '" class="col-xs-10"></div>
          </div>
          <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>门店营业时间： </label>
          <div class="col-sm-9"><input type="text" id="website-title" name="store_showtime" value="'; echo $row['store_showtime'];echo '" class="col-xs-10 "></div>
          </div>
          ...
          <div class="col-sm-9"><textarea name="beizhu" class="textarea">';echo $row['beizhu']; echo '</textarea></div>
          </div>
		...
		<div id="other" class="tab-pane">
          ...
          <div class="col-sm-9"><input type="text" name="gg_title" id="website-title" value="';echo $row['gg_title']; echo '" class="col-xs-10 "></div>
          </div>
		   <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>公告内容： </label>
          <div class="col-sm-9"><textarea class="textarea" name="gg_body">'; echo $row['gg_body']; echo '</textarea></div>
          </div>
          <div class="Button_operation">
				<button onclick="article_save_submit();" class="btn btn-primary radius" type="submit"><i class="fa fa-save "></i>&nbsp;保存</button>
 ...
 <div id="ottt" class="tab-pane">
          ...
          <div class="col-sm-9"><img src="';echo $row['store_img']; echo '" style="wdith:100px;height:100px;"/>  <br><br> <input type="file" name="image" /></div>
         <br><br>
           <br><br>
            <div class="Button_operation">
				<button onclick="article_save_submit();" class="btn btn-primary radius" type="submit"><i class="fa fa-save "></i>&nbsp;保存</button>
