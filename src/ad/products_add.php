...
<body>
   ...
   <div class="type_title">添加商品</div>
	<form action="action/products_add_action.php" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
    <div class="clearfix cl">
        <p>选择门店：&nbsp;&ensp;<select class="inp"  onchange="s_click(this)"  id="select" required>
		...
		<div class="clearfix cl">
         <p>商品分类：&nbsp;&ensp;<select class="inp" name="products_type" required>
         			 <?php
product_add_sort($admin_sql1,$fen_id);
...
?>
    ...
    <div class="clearfix cl" style="display:none">
         <p style="margin-left:-25px;">购买获得积分：<input type="text"  value="0" placeholder="请输入购买该商品用户可以获得的积分" id="" name="get_points" class="inp" required></p>
		</div>
		<div class="clearfix cl">
         <p>商品图片：</p>
        <P><img src=""></P>
        <P style="margin:20px 76px;"><input type="file" style="padding:10px 10px;" name="image">**商品图片比例最好接近1:1</P>
		</div>
