...
<html >
	...
	<body >
		<div id="shade"></div>
		<form action="../deal/chongzhi_action.php" method="POST" id="tijiao">
		<div class="head">
			<img src="../images/return.png" style="width:23px;float:left;margin-left:20px;" onClick="javascript:history.back(-1)"><span style=";">充值</span><span style="width:40px;float:right;">&nbsp;</span>
		</div>
	   <div style="height: 49px;"></div>
     <div class="money" ng-app="">
     <p style="padding:5px 10px;">充值金额</p>
     <div class="box">
	       <input type="text" name="money" value="" style="width:100%;border:0;outline:none;" id="money" placeholder="请输入您要充值的金额" step="0.01"  ng-model="quotnObject.quotnInfo.InterestTotal" currency-format="number" >
      </div>
      <div class="juli"></div>
	    <div class="pricebox">
		...
		<div class="paytype-logo" id="type3" <?php if(cart::$all_price>$user->money_still){ echo 'onClick="'; echo "alert('您的余额不足，不能使用会员卡进行付款')"; echo '"';} else{ echo ' onclick="ch()"';}?>" style="display:none;"/>
		...
		<input type="text" value="" name="paytype" id="pay" style="display:none"/>
		<div style="clear:both;"></div>
	</div>

	    	<div >
		<input type="button" class="btn" onclick="MyAutoRun()" value="确定充值" name="paytype"/>
		<p style="float:right;padding:0 30px;margin-top:-10PX;"><a href="chongzhi_log.php">查看充值记录</a></p>
	</div>
	</form>
	<!-- 支付密码输入弹出-->
