  ...
  <body>
    <div class="head"><? if($name==null){
      ...
      echo '<a href="./store_list.php"><img src="images/shuaxin.jpg" style="width:23px;float:left;margin-left:20px;" ></a>';
        ...
        <span style=";">选择门店 </span>	<img src="images/serch1.png" style="width:23px;float:right;margin-right:20px;" onClick="test()">
      </div>
      	<div style="padding-bottom:48px;"></div>
        <?php
        if($name==null){
            $sql="select * from store_setting where status = '1'";//查询语句
        }else{
          $sql="select * from store_setting where store_name like '%$name%'";//查询语句
        }
          ...
          foreach($ro as $key=>$v){
            echo '<a href="index.php?id=';echo $v['store_id']; echo '">
            <div class="list">
                  <div class="list_img">
                    <p>';echo $v['store_name']; echo '</p>
                  </div>
                  <p class="p1"><img src="images/foot4.png" style="width:17px;"/>&nbsp;';echo $v['store_place']; echo '</p>
              </div>';
          }if($ro == null){
